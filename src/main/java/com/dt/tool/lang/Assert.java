...
import com.dt.tool.util.support.CollectionKit;
...
public class Assert {
	...
	public static void isTrue(boolean expression, String errorMsgTemplate, Object... params)
			throws IllegalArgumentException {
		if (false == expression) {
			throw new IllegalArgumentException(StrKit.format(errorMsgTemplate, params));
		}
	}
	...
	public static <T> T notNull(T object, String errorMsgTemplate, Object... params) throws NullPointerException {
		if (object == null) {
			throw new NullPointerException(StrKit.format(errorMsgTemplate, params));
		}
		return object;
	}
	 ...
	 *            参数
	 * @return 非空字符串
	 * @see StrKit#isNotEmpty(CharSequence)
	 * @throws IllegalArgumentException
	 *             被检查字符串为空
	 */
	 ...
	 *            参数
	 * @return 非空字符串
	 * @see StrKit#isNotBlank(CharSequence)
	 * @throws IllegalArgumentException
	 *             被检查字符串为空白
	 */
	...
	public static String notContain(String textToSearch, String substring, String errorMsgTemplate, Object... params)
			throws IllegalArgumentException {
		if (StrKit.isNotEmpty(textToSearch) && StrKit.isNotEmpty(substring) && textToSearch.contains(substring)) {
			throw new IllegalArgumentException(StrKit.format(errorMsgTemplate, params));
		}
		return substring;
	}
	...
	public static void state(boolean expression, String errorMsgTemplate, Object... params)
			throws IllegalStateException {
		if (false == expression) {
			throw new IllegalStateException(StrKit.format(errorMsgTemplate, params));
		}
	}
