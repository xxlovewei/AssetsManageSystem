...
import com.dt.tool.date.DateUtil;
import com.dt.tool.enums.BITBoolean;
import com.dt.tool.enums.TFBoolean;
import com.dt.tool.enums.YNBoolean;
...
public class DataParser
{
	...
	public Boolean parseBoolean(Object val)
	{
		...
		else
		{
			...
			if(tf!=TFBoolean.NULL) return tf.getValue();
			
			BITBoolean bit=BITBoolean.parse(strval);
			if(bit!=BITBoolean.NULL) return bit.getValue();
