...
public class CustomizedRedisCacheManager extends RedisCacheManager {
	...
	/**
	 * 缓存参数的分隔符 数组元素0=缓存的名称 数组元素1=缓存过期时间TTL 数组元素2=缓存在多少秒开始主动失效来强制刷新
	 */
	...
	public CustomizedRedisCacheManager(@SuppressWarnings("rawtypes") RedisOperations redisOperations) {
		super(redisOperations);

	}

	public CustomizedRedisCacheManager(@SuppressWarnings("rawtypes") RedisOperations redisOperations, Collection<String> cacheNames) {
	...
	public Cache getCache(String name) {
		...
		CustomizedRedisCache redisCache = new CustomizedRedisCache(cacheName,
