...
public class RcdSetExporter
{
	...
	public RcdSetExporter(RcdSet set)
	{
		/*if (ENCODING == null)
		{
			ENCODING = ((AppContext) SpringUtil.getSringContext().getBean(
...
*/
	...
	public void asExcel(HttpServletResponse response,String fileName,String sheetName,HashMap<String, String> fieldMap)
	{
		try
		{ 
