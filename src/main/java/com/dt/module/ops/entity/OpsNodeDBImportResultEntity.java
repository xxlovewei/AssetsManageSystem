 ...
 * @Description: TODO
 */
public class OpsNodeDBImportResultEntity {
    ...
    public List<OpsNodeDBEntity> faileentity = new ArrayList<OpsNodeDBEntity>();
    ...
    public JSONObject covertJSONObjectResult() {
        ...
        if (failed_cnt > 0) {
            for (int i = 0; i < faileentity.size(); i++) {
                ...
                String name = faileentity.get(i).getXtname();
    ...
    public void addFailed(OpsNodeDBEntity re) {
