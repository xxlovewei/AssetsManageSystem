...
public class SysCardAddrController extends BaseController {
	...
	public R deleteById(@RequestParam(value = "id", required = true, defaultValue = "")String id) {
		return R.SUCCESS_OPER(SysCardAddrServiceImpl.removeById(id));
	}
	...
	public R selectById(@RequestParam(value = "id", required = true, defaultValue = "")String id) {
		return R.SUCCESS_OPER(SysCardAddrServiceImpl.getById(id));
	}
	...
	public R insert(SysCardAddr entity) {
		return R.SUCCESS_OPER(SysCardAddrServiceImpl.save(entity));
	}
	...
	public R insertOrUpdate(SysCardAddr entity) {
		return R.SUCCESS_OPER(SysCardAddrServiceImpl.saveOrUpdate(entity));
	}
	...
	public R selectList() {
		return R.SUCCESS_OPER(SysCardAddrServiceImpl.list(null));
	}
