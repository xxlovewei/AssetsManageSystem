...
public class SysFileConfController extends BaseController {
    ...
    public R deleteById(@RequestParam(value = "id", required = true, defaultValue = "") String id) {
        return R.SUCCESS_OPER(SysFileConfServiceImpl.removeById(id));
    }
    ...
    public R selectById(@RequestParam(value = "id", required = true, defaultValue = "") String id) {
        return R.SUCCESS_OPER(SysFileConfServiceImpl.getById(id));
    }
    ...
    public R insert(SysFileConf entity) {
        return R.SUCCESS_OPER(SysFileConfServiceImpl.save(entity));
    }
    ...
    public R insertOrUpdate(SysFileConf entity) {
        return R.SUCCESS_OPER(SysFileConfServiceImpl.saveOrUpdate(entity));
    }
    ...
    public R selectList() {
        return R.SUCCESS_OPER(SysFileConfServiceImpl.list(null));
    }
    ...
    public R selectPage(String start, String length, @RequestParam(value = "pageSize", required = true, defaultValue = "10") String pageSize, @RequestParam(value = "pageIndex", required = true, defaultValue = "1") String pageIndex) {
        ...
        QueryWrapper<SysFileConf> ew = new QueryWrapper<SysFileConf>();
        //ew.and(i -> i.eq("user_id", getUserId()).apply(pagesize>10, "rtime>sysdate-1","23"));
        IPage<SysFileConf> pdata = SysFileConfServiceImpl.page(new Page<SysFileConf>(pageindex, pagesize), ew);
