...
public class SmartImageScalr {
	...
	public void init(int width,int height,String fitType,String crop,double origWidth,double origHeight)
	{
		 ...
		 if(fitType==null || (!fitType.equals("width") && !fitType.equals("height"))) fitType="width";
	...
	private static String checkCropType(String type)
	{
		...
		for (String c : CROPS) {
			if(c.equals(type) || type2.equals(c)) return c;
		}
		return null;
	}
	...
	public static void main(String[] args) throws Exception {
		...
		for (String crop : CROPS) {
			...
			for (String fitType : ftiTypes) {
				...
				ImageIO.write(thumb, format,new File("/Users/leefangjie/Downloads/thumbs/t/"+sc.getFileName(file,format)));
...
//		ImageIO.write(cropimage, "png",new File("/Users/leefangjie/Downloads/thumbs/attachment_y.png"));
		
//		BufferedImage th_1=scaleByWidth(bi,ImageType.JPG,100);
		
//		createImage(th_1,ImageType.PNG).writeToJPG(new File("/Users/leefangjie/Downloads/thumbs/attachment_z.png"), 100);
//		ImageIO.write(th_1, "png",new File("/Users/leefangjie/Downloads/thumbs/attachment_z.png"));
