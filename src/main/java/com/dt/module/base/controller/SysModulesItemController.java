 ...
 */
@Controller
@RequestMapping("/api/sysModulesItem")
public class SysModulesItemController extends BaseController {
	...
	public R updateById(SysModulesItem entity) {
		return R.SUCCESS_OPER(SysModulesItemServiceImpl.updateById(entity));
	}
