 ...
 */
@Controller
@RequestMapping("/api/base/sysApprovalNode")
public class SysApprovalNodeController extends BaseController {
	...
	public R deleteById(@RequestParam(value = "id", required = true, defaultValue = "") String id) {
		return R.SUCCESS_OPER(SysApprovalNodeServiceImpl.removeById(id));
	}
	...
	public R selectById(@RequestParam(value = "id", required = true, defaultValue = "") String id) {
		return R.SUCCESS_OPER(SysApprovalNodeServiceImpl.getById(id));
	}

	@ResponseBody
	@Acl(info = "插入", value = Acl.ACL_USER)
	@RequestMapping(value = "/insert.do")
	public R insert(SysApprovalNode entity) {
		return R.SUCCESS_OPER(SysApprovalNodeServiceImpl.save(entity));
	}

	@ResponseBody
	@Acl(info = "根据Id更新", value = Acl.ACL_USER)
	@RequestMapping(value = "/updateById.do")
	public R updateById(SysApprovalNode entity) {
		return R.SUCCESS_OPER(SysApprovalNodeServiceImpl.updateById(entity));
	}
	...
	public R selectList() {
		return R.SUCCESS_OPER(SysApprovalNodeServiceImpl.list(null));
	}
	...
	public R selectPage(String start, String length, @RequestParam(value = "pageSize", required = true, defaultValue = "10")  String pageSize,@RequestParam(value = "pageIndex", required = true, defaultValue = "1")  String pageIndex) {
		...
		QueryWrapper<SysApprovalNode> ew = new QueryWrapper<SysApprovalNode>();
		//ew.and(i -> i.eq("user_id", getUserId()).apply(pagesize>10, "rtime>sysdate-1","23"));
		IPage<SysApprovalNode> pdata = SysApprovalNodeServiceImpl.page(new Page<SysApprovalNode>(pageindex, pagesize), ew);
