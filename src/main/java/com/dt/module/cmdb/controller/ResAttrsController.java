 ...
 */
@Controller
@RequestMapping("/api/cmdb/resAttrs")
public class ResAttrsController extends BaseController {
	...
	public R deleteById(@RequestParam(value = "id", required = true, defaultValue = "") String id) {
		return R.SUCCESS_OPER(ResAttrsServiceImpl.removeById(id));
	}
	...
	public R selectById(@RequestParam(value = "id", required = true, defaultValue = "") String id) {
		return R.SUCCESS_OPER(ResAttrsServiceImpl.getById(id));
	}

	@ResponseBody
	@Acl(info = "插入", value = Acl.ACL_USER)
	@RequestMapping(value = "/insert.do")
	public R insert(ResAttrs entity) {
		return R.SUCCESS_OPER(ResAttrsServiceImpl.save(entity));
	}

	@ResponseBody
	@Acl(info = "根据Id更新", value = Acl.ACL_USER)
	@RequestMapping(value = "/updateById.do")
	public R updateById(ResAttrs entity) {
		return R.SUCCESS_OPER(ResAttrsServiceImpl.updateById(entity));
	}
	...
	public R selectList() {
		return R.SUCCESS_OPER(ResAttrsServiceImpl.list(null));
	}
	...
	public R selectPage(String start, String length, @RequestParam(value = "pageSize", required = true, defaultValue = "10")  String pageSize,@RequestParam(value = "pageIndex", required = true, defaultValue = "1")  String pageIndex) {
		...
		IPage<ResAttrs> pdata = ResAttrsServiceImpl.page(new Page<ResAttrs>(pageindex, pagesize), ew);
