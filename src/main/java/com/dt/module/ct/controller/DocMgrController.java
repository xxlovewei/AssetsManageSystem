 ...
 */
@Controller
@RequestMapping("/api/ct/docMgr")
public class DocMgrController extends BaseController {
	...
	public R deleteById(@RequestParam(value = "id", required = true, defaultValue = "") String id) {
		return R.SUCCESS_OPER(DocMgrServiceImpl.removeById(id));
	}
	...
	public R selectById(@RequestParam(value = "id", required = true, defaultValue = "") String id) {
		return R.SUCCESS_OPER(DocMgrServiceImpl.getById(id));
	}

	@ResponseBody
	@Acl(info = "插入", value = Acl.ACL_USER)
	@RequestMapping(value = "/insert.do")
	public R insert(DocMgr entity) {
		return R.SUCCESS_OPER(DocMgrServiceImpl.save(entity));
	}

	@ResponseBody
	@Acl(info = "根据Id更新", value = Acl.ACL_USER)
	@RequestMapping(value = "/updateById.do")
	public R updateById(DocMgr entity) {
		return R.SUCCESS_OPER(DocMgrServiceImpl.updateById(entity));
	}
	...
	public R selectList() {
		return R.SUCCESS_OPER(DocMgrServiceImpl.list(null));
	}
	...
	public R selectPage(String start, String length, @RequestParam(value = "pageSize", required = true, defaultValue = "10") String pageSize, @RequestParam(value = "pageIndex", required = true, defaultValue = "1") String pageIndex) {
		...
		QueryWrapper<DocMgr> ew = new QueryWrapper<DocMgr>();
		//ew.and(i -> i.eq("user_id", getUserId()).apply(pagesize>10, "rtime>sysdate-1","23"));
		IPage<DocMgr> pdata = DocMgrServiceImpl.page(new Page<DocMgr>(pageindex, pagesize), ew);
