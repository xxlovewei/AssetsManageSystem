 ...
 */
@Controller
@RequestMapping("/api/ctBanner")
public class CtBannerController extends BaseController {


    @Autowired
    ICtBannerService CtBannerServiceImpl;
    ...
    public R updateById(CtBanner entity) {
        return R.SUCCESS_OPER(CtBannerServiceImpl.updateById(entity));
    }
