 ...
 */
@Controller
@RequestMapping("/api/zbx/zbxObjectItem")
public class ZbxObjectItemController extends BaseController {
    ...
    public R deleteById(@RequestParam(value = "id", required = true, defaultValue = "") String id) {
        return R.SUCCESS_OPER(ZbxObjectItemServiceImpl.removeById(id));
    }
    ...
    public R selectById(@RequestParam(value = "id", required = true, defaultValue = "") String id) {
        return R.SUCCESS_OPER(ZbxObjectItemServiceImpl.getById(id));
    }

    @ResponseBody
    @Acl(info = "插入", value = Acl.ACL_USER)
    @RequestMapping(value = "/insert.do")
    public R insert(ZbxObjectItem entity) {
        return R.SUCCESS_OPER(ZbxObjectItemServiceImpl.save(entity));
    }

    @ResponseBody
    @Acl(info = "根据Id更新", value = Acl.ACL_USER)
    @RequestMapping(value = "/updateById.do")
    public R updateById(ZbxObjectItem entity) {
        return R.SUCCESS_OPER(ZbxObjectItemServiceImpl.updateById(entity));
    }

    @ResponseBody
    @Acl(info = "存在则更新,否则插入", value = Acl.ACL_USER)
    @RequestMapping(value = "/insertOrUpdate.do")
    public R insertOrUpdate(ZbxObjectItem entity) {
        return R.SUCCESS_OPER(ZbxObjectItemServiceImpl.saveOrUpdate(entity));
    }
    ...
    public R selectList() {
        return R.SUCCESS_OPER(ZbxObjectItemServiceImpl.list(null));
    }
    ...
    public R selectPage(String start, String length, @RequestParam(value = "pageSize", required = true, defaultValue = "10") String pageSize, @RequestParam(value = "pageIndex", required = true, defaultValue = "1") String pageIndex) {
        ...
        IPage<ZbxObjectItem> pdata = ZbxObjectItemServiceImpl.page(new Page<ZbxObjectItem>(pageindex, pagesize), ew);
