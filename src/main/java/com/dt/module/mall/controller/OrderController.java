...
public class OrderController extends BaseController {
	...
	@ResponseBody
	@Acl(value = Acl.ACL_USER, info = "创建订单")
	...
	@ResponseBody
	@Acl(value = Acl.ACL_USER, info = "取消订单")
	...
	@ResponseBody
	@Acl(value = Acl.ACL_USER, info = "修改订单金额")
	...
	@ResponseBody
	@Acl(value = Acl.ACL_USER, info = "修改订单状态")
	...
	@ResponseBody
	@Acl(value = Acl.ACL_USER, info = "查询个人订单")
	...
	@ResponseBody
	@Acl(value = Acl.ACL_USER, info = "查询个人某个订单")
	...
	@ResponseBody
	@Acl(value = Acl.ACL_USER, info = "确认发货")
	...
	@ResponseBody
	@Acl(value = Acl.ACL_USER, info = "商品评价")
	...
	@ResponseBody
	@Acl(value = Acl.ACL_USER, info = "获取订单状态统计")
