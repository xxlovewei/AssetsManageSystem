 ...
 */
@Controller
@RequestMapping("/api/flow/sysProcessDef")
public class SysProcessDefController extends BaseController {
	...
	public R deleteById(@RequestParam(value = "id", required = true, defaultValue = "") String id) {
		return R.SUCCESS_OPER(SysProcessDefServiceImpl.removeById(id));
	}
	...
	public R selectById(@RequestParam(value = "id", required = true, defaultValue = "") String id) {
		return R.SUCCESS_OPER(SysProcessDefServiceImpl.getById(id));
	}

	@ResponseBody
	@Acl(info = "插入", value = Acl.ACL_USER)
	@RequestMapping(value = "/insert.do")
	public R insert(SysProcessDef entity) {
		return R.SUCCESS_OPER(SysProcessDefServiceImpl.save(entity));
	}

	@ResponseBody
	@Acl(info = "根据Id更新", value = Acl.ACL_USER)
	@RequestMapping(value = "/updateById.do")
	public R updateById(SysProcessDef entity) {
		return R.SUCCESS_OPER(SysProcessDefServiceImpl.updateById(entity));
	}

	@ResponseBody
	@Acl(info = "存在则更新,否则插入", value = Acl.ACL_USER)
	@RequestMapping(value = "/insertOrUpdate.do")
	public R insertOrUpdate(SysProcessDef entity) {
		return R.SUCCESS_OPER(SysProcessDefServiceImpl.saveOrUpdate(entity));
	}
	...
	public R selectList() {
		return R.SUCCESS_OPER(SysProcessDefServiceImpl.list(null));
	}
	...
	public R selectPage(String start, String length, @RequestParam(value = "pageSize", required = true, defaultValue = "10")  String pageSize,@RequestParam(value = "pageIndex", required = true, defaultValue = "1")  String pageIndex) {
		...
		IPage<SysProcessDef> pdata = SysProcessDefServiceImpl.page(new Page<SysProcessDef>(pageindex, pagesize), ew);
