 ...
 */
@Controller
@RequestMapping("/api/zc/resRepair")
public class ResRepairController extends BaseController {
	...
	public R selectById(@RequestParam(value = "id", required = true, defaultValue = "") String id) {
		return R.SUCCESS_OPER(ResRepairServiceImpl.getById(id));
	}

	@ResponseBody
	@Acl(info = "插入", value = Acl.ACL_USER)
	@RequestMapping(value = "/insert.do")
	public R insert(ResRepair entity) {
		return R.SUCCESS_OPER(ResRepairServiceImpl.save(entity));
	}

	@ResponseBody
	@Acl(info = "根据Id更新", value = Acl.ACL_USER)
	@RequestMapping(value = "/updateById.do")
	public R updateById(ResRepair entity) {
		return R.SUCCESS_OPER(ResRepairServiceImpl.updateById(entity));
	}

	@ResponseBody
	@Acl(info = "存在则更新,否则插入", value = Acl.ACL_USER)
	@RequestMapping(value = "/insertOrUpdate.do")
	public R insertOrUpdate(ResRepair entity) {
		return R.SUCCESS_OPER(ResRepairServiceImpl.saveOrUpdate(entity));
	}
	...
	public R selectList() {
		return R.SUCCESS_OPER(ResRepairServiceImpl.list(null));
	}
