 ...
 */
@Controller
@RequestMapping("/api/zc/resPurchase")
public class ResPurchaseController extends BaseController {
	...
	public R deleteById(@RequestParam(value = "id", required = true, defaultValue = "") String id) {
		return R.SUCCESS_OPER(ResPurchaseServiceImpl.removeById(id));
	}
	...
	public R insert(ResPurchase entity) {
		return R.SUCCESS_OPER(ResPurchaseServiceImpl.save(entity));
	}

	@ResponseBody
	@Acl(info = "根据Id更新", value = Acl.ACL_USER)
	@RequestMapping(value = "/updateById.do")
	public R updateById(ResPurchase entity) {
		return R.SUCCESS_OPER(ResPurchaseServiceImpl.updateById(entity));
	}
	...
	public R selectList() {
		return R.SUCCESS_OPER(ResPurchaseServiceImpl.list(null));
	}
	...
	public R selectPage(String start, String length, @RequestParam(value = "pageSize", required = true, defaultValue = "10")  String pageSize,@RequestParam(value = "pageIndex", required = true, defaultValue = "1")  String pageIndex) {
		...
		QueryWrapper<ResPurchase> ew = new QueryWrapper<ResPurchase>();
		//ew.and(i -> i.eq("user_id", getUserId()).apply(pagesize>10, "rtime>sysdate-1","23"));
		IPage<ResPurchase> pdata = ResPurchaseServiceImpl.page(new Page<ResPurchase>(pageindex, pagesize), ew);
