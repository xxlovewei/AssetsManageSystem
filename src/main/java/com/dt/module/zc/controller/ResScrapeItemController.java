 ...
 */
@Controller
@RequestMapping("/api/zc/resScrapeItem")
public class ResScrapeItemController extends BaseController {
	...
	public R deleteById(@RequestParam(value = "id", required = true, defaultValue = "") String id) {
		return R.SUCCESS_OPER(ResScrapeItemServiceImpl.removeById(id));
	}
	...
	public R selectById(@RequestParam(value = "id", required = true, defaultValue = "") String id) {
		return R.SUCCESS_OPER(ResScrapeItemServiceImpl.getById(id));
	}

	@ResponseBody
	@Acl(info = "插入", value = Acl.ACL_USER)
	@RequestMapping(value = "/insert.do")
	public R insert(ResScrapeItem entity) {
		return R.SUCCESS_OPER(ResScrapeItemServiceImpl.save(entity));
	}

	@ResponseBody
	@Acl(info = "根据Id更新", value = Acl.ACL_USER)
	@RequestMapping(value = "/updateById.do")
	public R updateById(ResScrapeItem entity) {
		return R.SUCCESS_OPER(ResScrapeItemServiceImpl.updateById(entity));
	}

	@ResponseBody
	@Acl(info = "存在则更新,否则插入", value = Acl.ACL_USER)
	@RequestMapping(value = "/insertOrUpdate.do")
	public R insertOrUpdate(ResScrapeItem entity) {
		return R.SUCCESS_OPER(ResScrapeItemServiceImpl.saveOrUpdate(entity));
	}
	...
	public R selectList() {
		return R.SUCCESS_OPER(ResScrapeItemServiceImpl.list(null));
	}
	...
	public R selectPage(String start, String length, @RequestParam(value = "pageSize", required = true, defaultValue = "10")  String pageSize,@RequestParam(value = "pageIndex", required = true, defaultValue = "1")  String pageIndex) {
		...
		IPage<ResScrapeItem> pdata = ResScrapeItemServiceImpl.page(new Page<ResScrapeItem>(pageindex, pagesize), ew);
