 ...
 */
@Controller
@RequestMapping("/api/zc/resChangeItem")
public class ResChangeItemController extends BaseController {
    ...
    public R deleteById(@RequestParam(value = "id", required = true, defaultValue = "") String id) {
        return R.SUCCESS_OPER(ResChangeItemServiceImpl.removeById(id));
    }
    ...
    public R selectById(@RequestParam(value = "id", required = true, defaultValue = "") String id) {
        return R.SUCCESS_OPER(ResChangeItemServiceImpl.getById(id));
    }

    @ResponseBody
    @Acl(info = "插入", value = Acl.ACL_USER)
    @RequestMapping(value = "/insert.do")
    public R insert(ResChangeItem entity) {
        return R.SUCCESS_OPER(ResChangeItemServiceImpl.save(entity));
    }

    @ResponseBody
    @Acl(info = "根据Id更新", value = Acl.ACL_USER)
    @RequestMapping(value = "/updateById.do")
    public R updateById(ResChangeItem entity) {
        return R.SUCCESS_OPER(ResChangeItemServiceImpl.updateById(entity));
    }

    @ResponseBody
    @Acl(info = "存在则更新,否则插入", value = Acl.ACL_USER)
    @RequestMapping(value = "/insertOrUpdate.do")
    public R insertOrUpdate(ResChangeItem entity) {
        return R.SUCCESS_OPER(ResChangeItemServiceImpl.saveOrUpdate(entity));
    }
    ...
    public R selectList() {
        return R.SUCCESS_OPER(ResChangeItemServiceImpl.list(null));
    }
    ...
    public R selectPage(String start, String length, @RequestParam(value = "pageSize", required = true, defaultValue = "10") String pageSize, @RequestParam(value = "pageIndex", required = true, defaultValue = "1") String pageIndex) {
        ...
        IPage<ResChangeItem> pdata = ResChangeItemServiceImpl.page(new Page<ResChangeItem>(pageindex, pagesize), ew);
