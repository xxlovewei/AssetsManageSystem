...
public class ResInventoryEntity implements java.io.Serializable {
    ...
    @Excel(name = "数据同步", width = 10)
    private String pdsyncneedstr;
    ...
    public void fullResEntity(JSONObject obj) {
        ...
        this.pdsyncneedstr = obj.getString("pdsyncneedstr");
    ...
    public String getPdsyncneedstr() {
        return pdsyncneedstr;
    }

    public void setPdsyncneedstr(String pdsyncneedstr) {
        this.pdsyncneedstr = pdsyncneedstr;
    }
}
