...
function sysfileConfCtl(DTLang, DTOptionsBuilder, DTColumnBuilder, $compile, $confirm, $log, notify, $scope, $http, $rootScope, $uibModal) {
...
//		return acthtml;
	...
	function flush() {
		...
		$http.post($rootScope.project + "/api/file/fileConfQuery.do", ps).success(function(res) {
			if (res.success) {
