function myassetsCtl($translate, DTOptionsBuilder, DTColumnBuilder, $compile, $confirm, $timeout,
    ...
    var fastbtn = "<div class=\"btn-group\" role=\"group\">\n" +
        ...
        "    </ul>\n" +
        "  </div>";
    $scope.URL = $rootScope.project + "/api/zc/my/queryMyResAll.do";
...
app.register.controller('myassetsCtl', myassetsCtl);