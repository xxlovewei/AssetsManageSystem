			...
			<div class="col-md-9">
				<div class="panel panel-warning">
					<div class="panel-heading">
						<label class="panel-title pull-left" style="margin-top: 5px"
							id="catalog"></label>
						<button
							class="btn btn-sm btn-success col-md-2 col-sm-3 pull-right"
							id="subCreate">Create fodder</button>
						<div class="col-md-2 pull-right">
							<input class="form-control input-sm" type="text" id="fName" />
						</div>
						<label class="control-label pull-right" for="fName"
							style="margin-top: 5px">Fodder name</label> <span
							class="clearfix"></span>
					</div>
					<div class="panel-body"
						style="height: 500px; padding: 0; overflow: scroll">
